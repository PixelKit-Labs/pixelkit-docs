...
| **Full Sanity Suite** | `05-full-sanity-suite.md` | All 32 hooks across all 4 template tabs | Traverses Silicon, Sensors, Actuators, and AI tabs; continuously audits Logcat for native `FATAL` exceptions. |
