...
| **[Autonomous E2E Testing with ARTEMIS](./testing-with-artemis.md)** | Autonomous end-to-end hardware verification on real Pixel devices using Google's ARTEMIS agent framework, testing genuine source: 'hardware' provenance across all 51 hooks. |
