...
| Hook | What it reads |
| :--- | :--- |
| [`useHiLight`](./usehilight.md) | The eight-LED ring around the rear camera flash. Real LEDs or nothing. |
| [`useUWB`](./useuwb.md) | Ultra-wideband radio state, hardware ranging sessions, and spatial diagnostics. |
<!-- hooks:end -->
