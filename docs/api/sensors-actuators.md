...
* [`useHealthConnect`](#usehealthconnect) - Android Health Connect & Hardware Sensor Vitals
* [`useCamera`](#usecamera) - Photo capture, video recording, zoom, flash, torch
* [`useCameraExtensions`](#usecameraextensions) - Google Computational Photography Extensions (Night Sight, Ultra HDR, Portrait Bokeh)
