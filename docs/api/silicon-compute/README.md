...
| [Observability & provenance](./observability-provenance.md) | How a reading reports where it came from, and what `null` means. |
| [PixelNative module](./pixelnative-module.md) | The Kotlin module the hooks read through, and the events it emits. |
